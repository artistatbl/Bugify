        ...
        content={
          <div className="w-full rounded-md bg-white p-2 sm:w-56">
            ...
            >
              ...
              <a
                href="/dashboard"
                className="inline-flex w-full cursor-pointer items-center justify-start space-x-2 rounded-md p-2 text-left text-sm transition-all duration-75 hover:bg-gray-100"
