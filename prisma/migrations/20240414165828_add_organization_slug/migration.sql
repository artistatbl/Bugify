...
-- CreateEnum
CREATE TYPE "Status" AS ENUM ('OPEN', 'IN_PROGRESS', 'CLOSED', 'OVERDUE', 'COMPLETED', 'CANCELLED', 'REOPENED', 'NOT_STARTED');

-- CreateEnum
CREATE TYPE "Priority" AS ENUM ('LOW', 'MEDIUM', 'HIGH', 'MORNAL', 'CRITICAL');
...
CREATE TABLE "Subscription" (
    ...
    CONSTRAINT "Subscription_pkey" PRIMARY KEY ("organizationId","userId")
);
